...
- summary: 한국어 2~4문장(짧게). 실습에서 확인된 강점·보완·다음 점검만.
- swot 각 항목: 한국어 1문장. 대화·사진·자기평가 근거가 있을 때만. 없으면 "추가 자료 필요".
          ...
          [
            {
              ...
              content:
                ...
                `형식: ## 총평(1~2문장) → ## 잘한 점(불릿 1~2) → ## 보완(불릿 1~2) → ## 안전(해당 시). **250~450자**.\n` +
...
`
  ...
  return `실습 채팅 — 짧은 요약형 답변.
- 형식: ## 요약(1줄) → ## 핵심(불릿 2~3) → ## 할 일(불릿 1~2). 안전은 맨 위 ## 안전(1문장).
- 분량 **200~380자**. 동문서답·강의 금지.
